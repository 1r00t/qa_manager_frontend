...
export interface paths {
	...
	"/api/sections/tree/": {
		/** Section Tree */
		get: operations["tests_api_section_tree"];
	};
	...
	"/api/testcases/by_id/": {
		/** Testcases By Id */
		post: operations["tests_api_testcases_by_id"];
	};
	"/api/testcases/search/": {
		/** Testcases Search */
		post: operations["tests_api_testcases_search"];
	};
	...
	"/api/testcases/section/{section_id}/": {
		/** Testcases By Section */
		get: operations["tests_api_testcases_by_section"];
	};
	"/api/testruns/": {
		/** Testrun List */
...
export interface components {
	schemas: {
		...
		SectionTreeOut: {
			...
			name: string;
			/** Children */
			children: components["schemas"]["SectionTreeOut"][];
		};
		/** SectionPatch */
		SectionPatch: {
			/** Name */
...
export interface operations {
	...
	tests_api_section_tree: {
		/** Section Tree */
		responses: {
			/** @description OK */
			200: {
				content: {
					"application/json": components["schemas"]["SectionTreeOut"][];
				};
			};
		};
	};
	...
	tests_api_testcases_by_section: {
		/** Testcases By Section */
		parameters: {
			path: {
				section_id: number;
